...
def create_app(test_config=None):
    ...
    @app.get("/api/admin/knowledge/<int:document_id>/chunks")
    @token_required("admin")
    ...
    @app.post("/api/admin/knowledge/<int:document_id>/reindex")
    @token_required("admin")
    ...
    @app.get("/api/admin/rag-traces/<trace_id>")
    @token_required("admin")
